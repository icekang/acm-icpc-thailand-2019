...
<div class = "px-5 mx-5 mt-5">
    ...
    <ul>
        <li>A student must be willing and able to compete in the World Finals. In particular, a student who is attending the team’s institution on a visa must have permission to travel to the return destination after the World Finals.</li>
        <li>A student must be enrolled in a degree program at the team’s institution with at least a half-time load. This rule is not to be construed as disqualifying co-op students, exchange students, students serving internships, or extramural students.</li>
    ...
    <ol>
        ...
        <li>A team can bring up to 3 identical copies of Team Reference Document which is defined as follows.
            <ul>
                <li><b>Team Reference Document</b> consists of letter-size or A4-size papers containing notes and/or printed pages (single-sided or double-sided). The total number of pages of the document must not exceed 25 pages. <i style="text-decoration: underline;">All pages must be numbered and the team name and university must appear in the header of every page.</i> Documents must be bought in a folder or stapled together.</li>
                <li>The copies of <b>Team Reference Document and other permitted items</b> will be reviewed by an inspector and <b>left at team’s workstation</b> on the first day (practice session) to be used in the contest session on the next day.</li>
            </ul>
        </li>
    ...
    <ol>
        ...
        <li>Solutions to contest problems submitted for judging are called runs. Each run is judged as accepted (Yes) or rejected (No) by a judge, and the team is notified of the results within a few minutes after the reception of the run.</li>
        <li>A team should stay logged-in to the PC2 system throughout the contest time with their own account. Logging-in as another team is considered as a cheat.</li>
        <li>Teams should inform the volunteers if they do not get a reply from the judges within 15 minutes after submission. Volunteers will report that to the judges. Teams should also notify the volunteers immediately if any problem concerning PC2 system (e.g. disconnection, forgotten password, program freezing) occurs. Complaints regarding these topics made after the contest is finished may not be considered.</li>
        <li>Notification of rejected or accepted runs to the contestant teams will not be suspended for the last one hour of the contest time but to keep the final result secret the displayed scoreboard will not be updated for last 1 hour.</li>
        <li>A contestant may submit a clarification request to judges. If the judges agree that an ambiguity error exists, a clarification will be issued to all contestants. A trivial request may not be responded.</li>
        <li>Contestants are not to converse with anyone except members of their team and personnel designated by the organizing committee. Systems support staff may advise contestants on system-related problems such as explaining system error messages.</li>
        <li>A team may be disqualified by the Contest Committee for any cheat or attempt of cheating. A team may also be disqualified for any activity that jeopardizes the contest such as dislodging extension cords, unauthorized modification of contest materials, or distracting behavior.</li>
    ...
    <ol>
        ...
        <li>Teams are ranked according to the most problems solved. For the purposes of awards, or in determining qualifier(s) for the World Finals, teams who solve the same number of problems are ranked by least total time. In the case of equal total time, the less time of the latest problem solved of each team (not including penalty time for that problem) will determine the higher ranked team. If still equal, the time of next-latest problem(s) will be considered.</li>
        <li>During the contest the live scoreboard (containing the number of problems solved of each team and the current ranking) will be shown to the people outside the contest rooms. The contestants and coaches can also have an access to the live scoreboard during the contest. However, the scoreboard will be frozen at about 1 hour before the end of the contest in order to keep the final results secret.</li>
        <li>Each submission, called <i>run</i> will get one of these responses from the judges:
            <ul>
                <li>Yes – Accepted. <br>
                The program produced the correct output within running time limit without any error. This program is accepted by the judges and the problem is considered as solved.</li>
                <li>No – Wrong Answer. <br>
                The program did not produce the correct output.</li>
                <li>No – Runtime Error. <br>
                The program crashed (runtime error) when processing the secret test data.</li>
                <li>No – Time Limit Exceeded. <br>
                The program took more than the time limit to produce output and terminate correctly.</li>
                <li>No – Compilation Error. <br>
                The submitted source code cannot be compiled.</li>
            </ul>
            <p>All four <i>No</i> responses are considered rejection and will increase your time by 20 minutes if you solve the problem.</p>
